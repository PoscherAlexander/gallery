        ...
        data: {
            template: `<div class="uk-lightbox uk-overflow-hidden">
                    ...
                    <div class="uk-lightbox-toolbar uk-position-top uk-text-right uk-transition-slide-top uk-transition-opaque">
                        <a class="uk-icon-link uk-margin-small-left" data-target="#modalDelete" data-href="delete.php/?n=` + name + `" uk-icon="icon: trash; ratio: 1.2;" id="lightboxDelete" uk-toggle></a>
